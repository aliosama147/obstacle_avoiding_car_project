...
byte stopDist = 40;                               //Minimum distance from an object to stop in cm
float timeOut = 2*(maxDist+10)/100/340*1000000;   //Maximum time to wait for a return signal
char value;                                       //value returned from the app to be received by the HC-05

int motorSpeed = 90;                             //The maximum motor speed
int motorOffset = 0;                             //Factor to account for one side being more powerful
int turnSpeed = 0;                               //Amount to add to motor speed when turning
